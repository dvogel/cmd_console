...
class CmdConsole
  module Helpers
    def self.tablify_or_one_line(heading, things, pry_instance = CmdConsole.new)
      plain_heading = CmdConsole::Helpers::Text.strip_color(heading)
    ...
    def self.tablify_to_screen_width(things, options, pry_instance = CmdConsole.new)
      options ||= {}
    ...
    def self.tablify(things, line_length, pry_instance = CmdConsole.new)
    ...
    class Table
      ...
      def initialize(items, args, pry_instance = CmdConsole.new)
      ...
      def _rebuild_colorless_cache
        ...
        @plain_items = []
        items.map do |e|
          plain = CmdConsole::Helpers::Text.strip_color(e)
