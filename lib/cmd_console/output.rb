...
class CmdConsole
  class Output
    ...
    def decolorize_maybe(str)
      ...
      CmdConsole::Helpers::Text.strip_color(str)
    end
    ...
    def io_console_size
      return if CmdConsole::Helpers::Platform.jruby?
    ...
    def env_size
      size = [CmdConsole::Env['LINES'] || CmdConsole::Env['ROWS'], CmdConsole::Env['COLUMNS']]
    ...
    def ansicon_env_size
      return unless CmdConsole::Env['ANSICON'] =~ /\((.*)x(.*)\)/
