...
class CmdConsole
  class Command
    class Help < CmdConsole::ClassCommand
      match 'help'
      group 'Help'
      ...
      # @param [Array<CmdConsole::Command>] commands
      ...
      #
      # @param [Array<CmdConsole::Command>] commands The commands to sort
      # @return [Array<CmdConsole::Command>] commands sorted by listing name.
    ...
    CmdConsole::Commands.add_command(CmdConsole::Command::Help)
  end
end
