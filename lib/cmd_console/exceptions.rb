...
class CmdConsole
  ...
  # from exiting CmdConsole when they want to.
  ...
  # An Exception Tag (cf. Exceptional Ruby) that instructs CmdConsole to show the error
  # in a more user-friendly manner. This should be used when the exception
  # happens within CmdConsole itself as a direct consequence of the user typing
  # something wrong.
  #
