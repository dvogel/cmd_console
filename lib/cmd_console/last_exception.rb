...
#
# {CmdConsole::LastException} is a proxy class who wraps an Exception object for
# {CmdConsole#last_exception}. it extends the exception object with methods that
